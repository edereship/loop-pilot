...
```markdown
🛑 **Auto-review stopped** — max iterations reached — `/restart-review --hard` to retry.
...
```markdown
🛑 **Auto-review stopped** — CHECK_COMMAND failed after the repair — fix the failure and `/restart-review`.
